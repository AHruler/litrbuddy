...
def graph_nodes(
    ...
    if threshold is None:
        transition_matrix = create_markov_matrix(similarity_matrix)
    else:
        print('function only returns contious matrix')
        return
    ...
    print('grouped_indices length', len(grouped_indices))
    ...
    return transition_matrix, distribution, grouped_indices
