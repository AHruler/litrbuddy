...
REF_GROBID_CONFIG = {
    "grobid_server": "localhost",
    "grobid_port": "8070",
    "coordinates": [ "persName", "figure", "ref", "biblStruct", "formula", "s", "note"],
    "sleep_time": 5,
    "timeout": 60,
    "generateIDs": False,
...
class GrobidClient(ApiClient):
    ...
    def __init__(self, config=None, test=False):
        if config is None:
            ...
            self.config = REF_GROBID_CONFIG

        self.tei_coordinates = True if "coordinates" in self.config else False
